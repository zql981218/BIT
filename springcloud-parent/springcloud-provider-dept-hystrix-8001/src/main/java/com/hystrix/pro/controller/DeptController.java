package com.hystrix.pro.controller;
...
public class DeptController {
	...
	//体现断路器用途
		public Dept hystrixDemo(@PathVariable("id") Long id){
			return new Dept().setDeptno(id).setDname("该Id："+id+"不存在，").setDb_source("在数据库中没有对应的数据");
		}
}
